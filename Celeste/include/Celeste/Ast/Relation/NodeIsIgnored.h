#ifndef CELESTE_AST_RELATION_NODEISIGNORED_H
#define CELESTE_AST_RELATION_NODEISIGNORED_H

#include "Celeste/Ast/Enum/Type.h"

namespace Celeste { namespace ast { namespace relation { 

	constexpr static bool NodeIsIgnored(::Celeste::ast::Type t)
	{
...
#endif // CELESTE_AST_RELATION_NODEISIGNORED_H