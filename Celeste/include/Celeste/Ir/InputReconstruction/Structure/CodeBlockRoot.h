#ifndef CELESTE_IR_INPUTRECONSTRUCTION_STRUCTURE_CODEBLOCKROOT_H
#define CELESTE_IR_INPUTRECONSTRUCTION_STRUCTURE_CODEBLOCKROOT_H
...
{
	class CodeBlockRoot : public InputReconstructionObject
	{
	private:
	...
	public:
		CodeBlockRoot();
		virtual ~CodeBlockRoot() = default;

		CodeBlockRoot(const CodeBlockRoot& rhs);
...
#endif // CELESTE_IR_INPUTRECONSTRUCTION_STRUCTURE_CODEBLOCKROOT_H
