...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    FILE_ = 284,                   /* FILE_  */
    PROGRAM_ = 285,                /* PROGRAM_  */
    IMPORT = 286,                  /* IMPORT  */
    PUBLIC = 287,                  /* PUBLIC  */
    PROTECTED = 288,               /* PROTECTED  */
    PRIVATE = 289,                 /* PRIVATE  */
    INHERIT = 290,                 /* INHERIT  */
    COMPOSITE = 291,               /* COMPOSITE  */
    ...
    LEFT_PARANTHESIS = 296,        /* LEFT_PARANTHESIS  */
    RIGHT_PARANTHESIS = 297,       /* RIGHT_PARANTHESIS  */
    COLON = 298,                   /* COLON  */
    ...
    PLUSEQ = 306,                  /* PLUSEQ  */
    MINUSEQ = 307,                 /* MINUSEQ  */
    MULTIPLYEQ = 308,              /* MULTIPLYEQ  */
    DIVIDEEQ = 309,                /* DIVIDEEQ  */
    EQEQ = 310,                    /* EQEQ  */
    EQ = 311,                      /* EQ  */
    NOTEQ = 312,                   /* NOTEQ  */
    NOT = 313,                     /* NOT  */
