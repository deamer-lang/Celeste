...
enum_block.Set(::deamer::language::type::definition::object::main::NonTerminal("enum_block", { enum_block_LEFT_BRACKET_deamerreserved_star__enum_stmt___RIGHT_BRACKET.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , false));
deamerreserved_star__enum_stmt__.Set(::deamer::language::type::definition::object::main::NonTerminal("deamerreserved_star__enum_stmt__", { deamerreserved_star__enum_stmt___enum_stmt_deamerreserved_star__enum_stmt__.Pointer(),deamerreserved_star__enum_stmt___EMPTY.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , true));
function_declaration.Set(::deamer::language::type::definition::object::main::NonTerminal("function_declaration", { function_declaration_FUNCTION_function_name_LEFT_PARANTHESIS_deamerreserved_arrow__function_argument___function_argument_RIGHT_PARANTHESIS_return_type_SEMICOLON.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , false));
deamerreserved_arrow__function_argument__.Set(::deamer::language::type::definition::object::main::NonTerminal("deamerreserved_arrow__function_argument__", { deamerreserved_arrow__function_argument___function_argument_deamerreserved_star__COMMA__.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , true));
function_implementation.Set(::deamer::language::type::definition::object::main::NonTerminal("function_implementation", { function_implementation_FUNCTION_function_name_LEFT_PARANTHESIS_deamerreserved_arrow__function_argument___function_argument_RIGHT_PARANTHESIS_return_type_function_block.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , false));
...
enum_stmt.Set(::deamer::language::type::definition::object::main::NonTerminal("enum_stmt", { enum_stmt_COMMA_VARNAME_COMMA.Pointer(),enum_stmt_COMMA_VARNAME.Pointer(),enum_stmt_VARNAME_COMMA.Pointer(),enum_stmt_VARNAME.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Group , false));
...
deamerreserved_star__enum_stmt___enum_stmt_deamerreserved_star__enum_stmt__.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->enum_stmt.Pointer(),Language->deamerreserved_star__enum_stmt__.Pointer() }));
deamerreserved_star__enum_stmt___EMPTY.Set(::deamer::language::type::definition::object::main::ProductionRule());
enum_block_LEFT_BRACKET_deamerreserved_star__enum_stmt___RIGHT_BRACKET.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->LEFT_BRACKET.Pointer(),Language->deamerreserved_star__enum_stmt__.Pointer(),Language->RIGHT_BRACKET.Pointer() }));
deamerreserved_arrow__function_argument___function_argument_deamerreserved_star__COMMA__.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->function_argument.Pointer(),Language->deamerreserved_star__COMMA__.Pointer() }));
function_declaration_FUNCTION_function_name_LEFT_PARANTHESIS_deamerreserved_arrow__function_argument___function_argument_RIGHT_PARANTHESIS_return_type_SEMICOLON.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->FUNCTION.Pointer(),Language->function_name.Pointer(),Language->LEFT_PARANTHESIS.Pointer(),Language->deamerreserved_arrow__function_argument__.Pointer(),Language->function_argument.Pointer(),Language->RIGHT_PARANTHESIS.Pointer(),Language->return_type.Pointer(),Language->SEMICOLON.Pointer() }));
function_implementation_FUNCTION_function_name_LEFT_PARANTHESIS_deamerreserved_arrow__function_argument___function_argument_RIGHT_PARANTHESIS_return_type_function_block.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->FUNCTION.Pointer(),Language->function_name.Pointer(),Language->LEFT_PARANTHESIS.Pointer(),Language->deamerreserved_arrow__function_argument__.Pointer(),Language->function_argument.Pointer(),Language->RIGHT_PARANTHESIS.Pointer(),Language->return_type.Pointer(),Language->function_block.Pointer() }));
...
enum_stmt_COMMA_VARNAME_COMMA.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->COMMA.Pointer(),Language->VARNAME.Pointer(),Language->COMMA.Pointer() }));
enum_stmt_COMMA_VARNAME.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->COMMA.Pointer(),Language->VARNAME.Pointer() }));
enum_stmt_VARNAME_COMMA.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->VARNAME.Pointer(),Language->COMMA.Pointer() }));
...
AddObject(deamerreserved_star__enum_stmt__);
AddObject(function_declaration);
AddObject(deamerreserved_arrow__function_argument__);
...
AddObject(deamerreserved_star__enum_stmt___enum_stmt_deamerreserved_star__enum_stmt__);
AddObject(deamerreserved_star__enum_stmt___EMPTY);
AddObject(enum_block_LEFT_BRACKET_deamerreserved_star__enum_stmt___RIGHT_BRACKET);
AddObject(deamerreserved_arrow__function_argument___function_argument_deamerreserved_star__COMMA__);
AddObject(function_declaration_FUNCTION_function_name_LEFT_PARANTHESIS_deamerreserved_arrow__function_argument___function_argument_RIGHT_PARANTHESIS_return_type_SEMICOLON);
AddObject(function_implementation_FUNCTION_function_name_LEFT_PARANTHESIS_deamerreserved_arrow__function_argument___function_argument_RIGHT_PARANTHESIS_return_type_function_block);
...
AddObject(enum_stmt_COMMA_VARNAME_COMMA);
AddObject(enum_stmt_COMMA_VARNAME);
AddObject(enum_stmt_VARNAME_COMMA);
