...
class_declaration.Set(::deamer::language::type::definition::object::main::NonTerminal("class_declaration", { class_declaration_CLASS_class_name_COLON_deamerreserved_arrow__base_type___class_block.Pointer(),class_declaration_CLASS_class_name_class_block.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , false));
deamerreserved_arrow__base_type__.Set(::deamer::language::type::definition::object::main::NonTerminal("deamerreserved_arrow__base_type__", { deamerreserved_arrow__base_type___base_type_deamerreserved_star__COMMA__base_type__.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , true));
deamerreserved_star__COMMA__base_type__.Set(::deamer::language::type::definition::object::main::NonTerminal("deamerreserved_star__COMMA__base_type__", { deamerreserved_star__COMMA__base_type___COMMA_base_type_deamerreserved_star__COMMA__base_type__.Pointer(),deamerreserved_star__COMMA__base_type___EMPTY.Pointer() } , ::deamer::language::type::definition::object::main::NonTerminalAbstraction::Standard , true));
...
deamerreserved_arrow__base_type___base_type_deamerreserved_star__COMMA__base_type__.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->base_type.Pointer(),Language->deamerreserved_star__COMMA__base_type__.Pointer() }));
deamerreserved_star__COMMA__base_type___COMMA_base_type_deamerreserved_star__COMMA__base_type__.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->COMMA.Pointer(),Language->base_type.Pointer(),Language->deamerreserved_star__COMMA__base_type__.Pointer() }));
deamerreserved_star__COMMA__base_type___EMPTY.Set(::deamer::language::type::definition::object::main::ProductionRule());
class_declaration_CLASS_class_name_COLON_deamerreserved_arrow__base_type___class_block.Set(::deamer::language::type::definition::object::main::ProductionRule({ Language->CLASS.Pointer(),Language->class_name.Pointer(),Language->COLON.Pointer(),Language->deamerreserved_arrow__base_type__.Pointer(),Language->class_block.Pointer() }));
...
AddObject(deamerreserved_star__COMMA__base_type__);
...
AddObject(deamerreserved_arrow__base_type___base_type_deamerreserved_star__COMMA__base_type__);
AddObject(deamerreserved_star__COMMA__base_type___COMMA_base_type_deamerreserved_star__COMMA__base_type__);
AddObject(deamerreserved_star__COMMA__base_type___EMPTY);
AddObject(class_declaration_CLASS_class_name_COLON_deamerreserved_arrow__base_type___class_block);
